...
<%--              <p class="mb-4">Make your app management easy and fun!</p>--%>
              ...
              <form id="formAuthentication" class="mb-3" action="/userInsert" method="POST">
                <div class="mb-3">
                  <input
                    type="text"
                    class="form-control"
                ...
                <div class="mb-3">
                  <input type="text" class="form-control" id="email" name="user_email" placeholder="이메일" />
                </div>
